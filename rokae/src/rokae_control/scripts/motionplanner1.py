...
class MoveItCartesianPath:
    def __init__(self):
        ...
        if fraction == 1.0:
            ...
            pub = rospy.Publisher('/rokae/arm_controller/command',
                                  JointTrajectory,
                                  queue_size=10)
            ...
            traj.joint_names = ["xmate_joint_1","xmate_joint_2","xmate_joint_3","xmate_joint_4","xmate_joint_5","xmate_joint_6","xmate_joint_7"]
